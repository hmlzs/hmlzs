...
<head>
    ...
    <link rel="stylesheet" href="${resURLPrefix}/static/base/kindeditor/themes/default/default.css">
    <script charset="utf-8" src="${resURLPrefix}/static/base/kindeditor/kindeditor-all-min.js"></script>
    <script charset="utf-8" src="${resURLPrefix}/static/base/kindeditor/lang/zh_CN.js"></script>
            ...
            items: form = Ext.create('Ext.form.FormPanel', {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        anchor: '100% 100%',
                        xtype: 'panel',
                        html: '<textarea id="content-area" style="width: 100%; height: 480px;"></textarea>',
                        listeners: {
                            afterrender: function (self, eOpts) {
                                editor = KindEditor.create('#content-area', {
                                    resizeType: 1,
